...
theme.set_highlights = function()
  ...
  hl(0, "String", { fg = c.html_string, bg = 'NONE' })
  ...
  hl(0, "Delimiter", { fg = c.orange, bg = 'NONE' })
  ...
  hl(0, "TSPunctDelimiter", { fg = c.orange, bg = 'NONE' })
  ...
  hl(0, "TSString", { fg = c.import_string, bg = 'NONE' })
  ...
  hl(0, "NvimTreeFolderName", { fg = c.white, bg = 'NONE' })
